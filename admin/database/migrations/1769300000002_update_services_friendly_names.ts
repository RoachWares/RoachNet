...
export default class extends BaseSchema {
  ...
  async up() {
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'roachnet_kiwix_serve'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'roachnet_kolibri'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'roachnet_ollama'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'roachnet_flatnotes'
    `)
    ...
    await this.db.rawQuery(`
      ...
      WHERE service_name = 'roachnet_cyberchef'
    `)
  }
